...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-c6c-3zy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-c6c-3zy.containers.anotherwebservice.com/
...
```
git clone git@github.com:halilg1739/container-c6c-3zy.git
cd container-c6c-3zy
```
...
```
docker attach container-c6c-3zy
```
